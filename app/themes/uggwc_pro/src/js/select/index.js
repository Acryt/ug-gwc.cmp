...
// 	selects.forEach(el => {
// 		const selectTitle = el.querySelector(".form_select__title");
// 		const selectLabels = el.querySelectorAll(".form_select__label");
// 		// Toggle menu
...
// 		// Reset title
// 		// const reset = document.querySelector(".form_select__reset");

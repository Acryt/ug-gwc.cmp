		...
		<div class="section__content">
			...
			<div class="worker__item shadow">
				...
				<?php if ($item['cf_client_whatsapp']) { ?>
					<a target="_blank" href="https://wa.me/<?php echo $item['cf_client_whatsapp'] ?>"><div class="worker__whats"></div></a>
				<?php } ?>
				...
				<?php if ($item['cf_client_phone']) { ?>
					<a href="tel:<?php echo $item['cf_client_phone'] ?>"><div class="worker__phone"></div></a>
				<?php } ?>
				</div>
			</div>
			<?php } ?>

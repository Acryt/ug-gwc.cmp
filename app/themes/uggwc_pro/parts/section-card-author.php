	...
	<div class="wrapper">
		...
		<div class="section__content">
			...
			<div class="worker__item shadow">
				...
				<span class="worker__name h5"><?php echo $item['cf_author_name'] ?></span>
				<span class="worker__spec h6"><?php echo $item['cf_author_spec'] ?></span>
				...
				<?php if ($item['cf_author_whatsapp']) { ?>
					<a class="js-wapp" target="_blank" rel="noopener" href="https://wa.me/<?php echo Helpers::del_space($item['cf_author_whatsapp']) ?>"><div class="worker__whats"></div></a>
				<?php } ?>

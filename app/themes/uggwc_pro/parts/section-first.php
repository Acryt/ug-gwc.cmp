<section id="first" class="section first">
	...
	<div class="wrapper first__container">
		...
		?>
		<?php if (is_page_template(['templates/home.php', 'templates/disziplinen.php', 'templates/leistungen.php', 'templates/leistungen1.php', 'templates/leistungen2.php', 'templates/leistungen3.php', 'templates/lektorat.php', 'templates/city.php', 'templates/beispiele.php', 'templates/price.php', 'templates/leistungen-gut.php'])) { ?>
			<div class="first__side card shadow">
				<img class="wow animate__jello first__hat animate__repeat-2 animate__delay-2s"
					src="<?php echo URI . '/assets/images/first/hat.svg' ?>" alt="">

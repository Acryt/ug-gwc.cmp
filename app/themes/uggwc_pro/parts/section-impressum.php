	...
	<div class="wrapper">
		...
		<div class="section__content">
			<div class="about__organisation card shadow">
				...
				<div class="icons">
					<a target="_blank" rel="noopener" class="soc__icon" href="https://wa.me/<?php echo Helpers::del_space(carbon_get_theme_option('cf_whatsapp')); ?>"><i class="fa-brands fa-whatsapp"></i></a>
					...
					<a target="_blank" rel="noopener" class="soc__icon" href="<?php echo carbon_get_theme_option('cf_instagram'); ?>"><i class="fa-brands fa-instagram"></i></a>
				</div>
			...
			<div class="about__blocks">
				...
				<div class="about__comment card shadow">
					<img class="about__quote" src="<?php bloginfo('template_url'); ?>/assets/images/icons/quote.svg" alt="Quote Icon">
					<div class="about__text"><?php echo carbon_get_theme_option('cf_about_text'); ?></div>
					<img class="about__photo" src="<?php echo carbon_get_theme_option('cf_about_photo'); ?>" alt="Photo">
					<p class="about__name"><?php echo carbon_get_theme_option('cf_about_name'); ?> <span><?php echo carbon_get_theme_option('cf_about_spec'); ?></span></p>
				</div>
			</div>
		</div>
	</div>

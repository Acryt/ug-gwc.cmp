<section id="promoblock" class="section promoblock">
	<div class="wrapper">
		<!-- <div class="section__header"> -->
			<!-- <h2><?php echo carbon_get_theme_option('cf_promoblock_title') ?></h2> -->
			<!-- <p><?php echo carbon_get_theme_option('cf_promoblock_subtitle') ?></p> -->
		<!-- </div> -->
		<div class="section__content">
			...
			<div class="promoblock__text">
				<div class="promoblock__timer timer" data-end="2023-05-31"></div>

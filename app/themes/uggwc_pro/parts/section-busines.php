	...
	<div class="wrapper">
		...
		<div class="section__content">
			...
			<div class="busines__text card shadow">
				...
				<a target="_blank" class="busines__register" href="https://www.unternehmensregister.de/ureg/result.html;jsessionid=73BE561BFB6B7AA977BC69C26C0868E7.web03-1"><img src="<?php bloginfo('template_url'); ?>/assets/images/review/register.svg" alt=""></a>
			</div>
		</div>
	</div>
</section>
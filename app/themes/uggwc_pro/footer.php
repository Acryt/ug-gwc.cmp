	...
	<div class="wrapper">
		<div class="footer__content">
			<div class="footer__one">
				...
				<a target="_blank" class="footer__register" href="<?php echo carbon_get_theme_option('cf_register') ?>"><img
						src="<?php bloginfo('template_url'); ?>/assets/images/review/register.svg" alt=""></a>
